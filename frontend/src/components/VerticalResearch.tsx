...
export function VerticalResearch({ onRun, onPackage, report, post }: { onRun: (topic: string) => Promise<void>; onPackage: (topic: string, angle: string) => Promise<void>; report: Report | null; post: PostPackage | null }) {
